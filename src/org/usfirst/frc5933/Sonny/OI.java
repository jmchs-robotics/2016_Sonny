...
public class OI {
    ...
    public JoystickButton stop2;
    public JoystickButton rJButton;
    public JoystickButton lJButton;
    ...
    public OI() {
        ...
        lJButton = new JoystickButton(xbox, 9);
        lJButton.whenPressed(new FlyFaster());
        rJButton = new JoystickButton(xbox, 10);
        rJButton.whenPressed(new FlySlower());
        stop2 = new JoystickButton(xbox, 8);
        stop2.whenPressed(new StopFrontFlap());
        stop = new JoystickButton(xbox, 8);
        stop.whenPressed(new StopBackFlap());
        ...
        yButton.whileHeld(new FrontFlapOpen());
        aButton = new JoystickButton(xbox, 1);
        aButton.whileHeld(new BackFlapClose());
        xButton = new JoystickButton(xbox, 3);
        xButton.whileHeld(new BackFlapOpen());
        ...
        SmartDashboard.putData("StopBackFlap", new StopBackFlap());
        SmartDashboard.putData("StopFrontFlap", new StopFrontFlap());
        SmartDashboard.putData("FlyFaster", new FlyFaster());
        SmartDashboard.putData("FlySlower", new FlySlower());
