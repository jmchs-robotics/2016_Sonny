...
public class ReleaseBall extends Command {
    ...
    protected void initialize() {
        Robot.ballRelease.initializeCounter();
        RobotMap.ballReleaseLeft.set(1);
    }
    ...
    protected boolean isFinished() {
        return Robot.ballRelease.isSwitchSet();
    }

    // Called once after isFinished returns true
    protected void end() {
        RobotMap.ballReleaseLeft.set(0);
    }
