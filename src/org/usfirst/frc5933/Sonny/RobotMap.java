...
public class RobotMap {
    ...
    public static CANTalon frontFlapperFrontFlapMotor;
    public static CANTalon backFlapperBackFlapMotor;
    ...
    public static void init() {
        ...
        frontFlapperFrontFlapMotor = new CANTalon(5);
        LiveWindow.addActuator("Front Flapper", "Front Flap Motor", frontFlapperFrontFlapMotor);
        
        backFlapperBackFlapMotor = new CANTalon(6);
