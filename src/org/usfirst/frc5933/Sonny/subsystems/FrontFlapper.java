 ...
 *
 */
public class FrontFlapper extends Subsystem {
    ...
    private final Jaguar frontFlapMotor = RobotMap.frontFlapperFrontFlapMotor;
    ...
    public void runMotor(int power) {
    	frontFlapMotor.set(power);
    	// TODO: turn off when we get a switch
    		//RESOLVED: Jaguar

    	System.out.println("Running Front Flap: " + power);
    }
}
